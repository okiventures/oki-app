      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
        ...
        <View>
          ...
          {MOCK_KYC_REQUESTS.map((item) => (
            <Card key={item.id} className="mb-3 flex-row items-center p-3">
              ...
              <View className="items-end gap-2">
                ...
                <TouchableOpacity>
                  <Text className="text-primary-600 text-[11px] font-bold">Review</Text>
                </TouchableOpacity>
              </View>
            </Card>
          ))}
              ...
              <Card key={user.id} className="mb-3 p-3">
                ...
                {isSelected && (
                  <View className="mt-3 space-y-2 border-t border-gray-100 pt-3">
                    ...
                    <View className="flex-row gap-2">
                      <TouchableOpacity className="flex-1 items-center rounded-xl bg-gray-100 py-2">
                        <Text className="text-[12px] font-semibold text-gray-700">Suspend</Text>
                      </TouchableOpacity>
                      <TouchableOpacity className="bg-primary-600 flex-1 items-center rounded-xl py-2">
