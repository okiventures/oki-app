...
export default function AdminLayout() {
  const items = [
    ...
    { key: 'bookings', label: 'Bookings', icon: 'calendar-outline', activeIcon: 'calendar', route: '/(admin)/bookings' },
    { key: 'transactions', label: 'Payments', icon: 'card-outline', activeIcon: 'card', route: '/(admin)/transactions' },
