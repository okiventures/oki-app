...
export default function HandymanAuthScreen() {
  ...
  const signupValid = identifierIsValid && passwordIsValid && nameIsValid && hasService;
  const canSubmit =
    mode === 'login' ? identifierIsValid && password.trim().length > 0 : signupValid;
        ...
        <Card className="flex flex-col gap-4 px-8 py-10">
          <View className="items-center">
            ...
            <Text className="font-heading text-2xl text-gray-900">
              {mode === 'login' ? 'Welcome back!' : 'Become a Handyman'}
            </Text>
            <Text className="mt-2 text-center text-[13px] text-gray-500">
              {mode === 'login'
                ? 'Sign in to manage your services and jobs.'
                : 'Create your profile and start offering your services.'}
            </Text>
          </View>
          ...
          <View className="flex-row rounded-lg bg-gray-100 p-1">
            <TouchableOpacity
              ...
              <Text
                className={`text-[13px] font-semibold ${mode === 'login' ? 'text-gray-900' : 'text-gray-500'}`}>
                Sign In
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Text
                className={`text-[13px] font-semibold ${mode === 'signup' ? 'text-gray-900' : 'text-gray-500'}`}>
                Sign Up
              </Text>
            </TouchableOpacity>
          </View>
            ...
            {mode === 'signup' && (
              <>
                <Input
                  ...
                  error={
                    fullName.length > 0 && !nameIsValid ? 'Use at least 2 characters' : undefined
                  }
          ...
          <Button
            label={mode === 'login' ? 'Sign In' : 'Create Handyman Account'}
