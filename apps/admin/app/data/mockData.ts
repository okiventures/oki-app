...
export const MOCK_BOOKINGS = [
  {
    ...
    status: "Pending",
    description: "Leaking roof above the kitchen, needs urgent repair before weekend rain",
  ...
  },
  {
    ...
    status: "Accepted",
    description: "Bathroom sink drain is clogged, needs professional snaking",
  ...
  },
  {
    ...
    bookingType: "OnDemand",
    status: "WorkStarted",
    description: "Power outage in living room, circuit breaker keeps tripping",
