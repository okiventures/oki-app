  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        <div className="mb-3 px-2 text-[13px] font-bold text-gray-900">Active Resolutions</div>
        <SearchBar
          value={searchValue}
              ...
              <div
                ...
                <Card className="p-3">
                  ...
                  <p className="mb-3 text-[13px] text-gray-600">
                    <span className="font-semibold text-gray-800">{dispute.clientName}</span>{' '}
                    reported{' '}
                    <span className="font-semibold text-gray-800">{dispute.handymanName}</span>
                  </p>
                  <div className="flex flex-row gap-2">
                    <button className="flex-1 items-center rounded-md bg-gray-100 py-2 text-[13px] font-bold text-gray-700 hover:bg-gray-200">
                      Details
                    </button>
                    <button className="flex-1 items-center rounded-md bg-gray-900 py-2 text-[13px] font-bold text-white hover:bg-gray-800">
                      Resolve
                    </button>
                  </div>
                  {isExpanded && (
