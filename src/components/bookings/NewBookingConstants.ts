...
export const NEW_BOOKING_CATEGORIES: BookingCategory[] = [
  {
    ...
    subServices: [
      ...
      { id: 'massage-shiatsu', name: 'Shiatsu', description: 'Pressure-point based Japanese technique', startingPrice: 400 },
      { id: 'massage-foot', name: 'Foot Reflexology', description: 'Focused relief for feet and legs', startingPrice: 250 },
    ],
  },
  {
    id: 'cleaning',
    ...
    subServices: [
      ...
      { id: 'cleaning-aircon', name: 'Aircon Cleaning', description: 'Filter wash and unit cleaning', startingPrice: 400 },
      { id: 'cleaning-laundry', name: 'Laundry & Ironing', description: 'Wash, dry and press clothes', startingPrice: 200 },
    ],
  },
  {
    id: 'painting',
    ...
    subServices: [
      ...
      { id: 'painting-touch', name: 'Touch-Up & Repair', description: 'Minor scuffs, peeling, or patches', startingPrice: 350 },
    ],
  },
  {
    id: 'general',
