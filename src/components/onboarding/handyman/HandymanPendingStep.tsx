    ...
    <View className="gap-3">
      <Card className="items-center gap-3 py-6">
        ...
        <Text className="text-center text-[13px] leading-5" style={{ color: colors.ui.textMuted }}>
          We received your profile, service pricing, and KYC documents. Admin review usually takes
          less than 24 hours.
        </Text>
      </Card>
        ...
        <View className="mt-3 gap-2">
          {selectedServices.map((service) => (
            <View
              ...
              className="flex-row items-center justify-between rounded-2xl bg-gray-50 px-3 py-3">
      ...
      <Card>
        ...
        <View className="mt-3 gap-3">
          <PendingStepRow
            ...
            detail="Profile and document set saved to the review queue."
          />
          <PendingStepRow
            label="Admin verification"
            detail="Identity and service coverage are checked manually."
          />
          <PendingStepRow
            label="Account activation"
            detail="You can start accepting jobs once your badge switches to Approved."
          />
        </View>
      </Card>
    </View>
