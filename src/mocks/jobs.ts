...
export const MOCK_AVAILABLE_JOBS: JobCardData[] = [
  {
    ...
    distance: '1.2 km',
    description:
      'Kitchen sink is leaking underneath. Needs urgent fixing before it damages the cabinet.',
  ...
  },
  {
    ...
    distance: '3.5 km',
    description:
      'Install two new ceiling fans in the living room and master bedroom. Wiring is already present.',
    clientName: 'Kyle Lee',
    clientRating: 4.7,
  },
  {
    ...
    distance: '2.1 km',
    description:
      'Need help mounting a 65-inch TV on a drywall. I have the mount but need tools and expertise.',
    clientName: 'James Ty',
    clientRating: 5.0,
  },
];
